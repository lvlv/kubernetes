...
func (s *KubeletServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&s.KernelSupportPropagation, "kernel-support-propagation", s.KernelSupportPropagation, "Specify whether kernel supports propagation. If false, propagation in docker volume will never get set.")
}
